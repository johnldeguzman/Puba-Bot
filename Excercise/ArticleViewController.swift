...
open class ArticleViewController: UIViewController {
    ...
    fileprivate func setupImageView() {
        ...
        NSLayoutConstraint(item: imageView, attribute: .top, relatedBy: .equal, toItem: backgroundView, attribute: .top, multiplier: 1, constant: -20).isActive = true
    ...
    func tap(){
        let svc = SFSafariViewController(url: URL(string: self.url)!)
